...
<!-- Evidence, not assertion: paste the numbers.
     e.g. `npm test`: 214 pass / 1 fail — failure count identical to main baseline. -->

## Not verified

<!-- Which providers and models were actually exercised live, and which were
     not. Most of the suite mocks the API, so say so. "Nothing — verified
     end-to-end against Anthropic and OpenRouter" is a fine answer; silence
     is not. -->
